...
{
    public class OeKurirView
    {
        [Key]
        public int OeKurirId { get; set; }
        [Required]
        [MinLength(5)]
        [StringLength(5, ErrorMessage = "Kode Kurir terlalu panjang (5 character limit).")]
        public string Kurir { get; set; }
        [Required]
        [StringLength(100, ErrorMessage = "Nama Kurir terlalu panjang (100 character limit).")]
        ...
        public string NPWP_Kurir { get; set; }
        ...
        public string NamaLengkap
        {
            get
            {
                return NamaKurir + " [" + Kurir.ToUpper() + "]";
            }
        }
    }
}
