...
{
    public class OeSalesmanView
    {
        [Key]
        public int OeSalesmanId { get; set; }
        [Required]
        [MinLength(5)]
        [StringLength(5, ErrorMessage = "Kode Salesman terlalu panjang (5 character limit).")]
        public string Salesman { get; set; }
        [Required]
        [StringLength(100, ErrorMessage = "Nama Salesman terlalu panjang (100 character limit).")]
        ...
        public string NPWP_Sales { get; set; }
        ...
        public string NamaLengkap
        {
            get
            {
                return NamaSales + " [" + Salesman.ToUpper() + "]";
            }
        }
    }
}
